...
<body>
    ...
    <section id="list">
	    <div class="mainP">
	        <form action="write_modify?no=${content.no }" method=post name="writeForm">
	            <div>
	            ...
	            <table border=0 align=center width='1024' class="txt" align=center>
	                ...
	                <tr>
	                    ...
	                    <textarea name="icontent" cols="79" rows="15">${content.text }</textarea></td>
	                </tr>
	                <tr>
